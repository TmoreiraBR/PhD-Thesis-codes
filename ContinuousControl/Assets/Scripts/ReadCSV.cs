...
public class ReadCSV : MonoBehaviour
{
    ...
    void ReadCSVFile()
    {
        ...
        StreamReader strReader = new StreamReader("D:\\UnityMLAgentsProjects\\ml-agents-release_10\\ContinuousControl\\Assets\\Scripts\\_wansea2.csv"); // Add Path for loading file
